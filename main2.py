        ...
        for producto in contenedor_productos:
            ...
            if precio_contenedor:
                ...
                if precio_actual:
                    ...
                    precio_actual_centavos = precio_actual.find("span", class_="andes-money-amount__cents andes-money-amount__cents--superscript-24")
                    if precio_actual_fraccion and precio_actual_centavos:
                        precio = f"${precio_actual_fraccion.text}.{precio_actual_centavos.text}"
